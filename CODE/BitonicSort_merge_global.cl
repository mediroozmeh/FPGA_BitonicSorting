...
global_comparatorI[get_local_id(0) ] = get_global_id(0);
 comparatorI[get_local_id(0) ] = global_comparatorI[get_local_id(0) ] & (arrayLength / 2 - 1);
   dir[get_local_id(0)] = sortDir ^ ( (comparatorI[get_local_id(0) ]  & (size / 2)) != 0 );
    pos[get_local_id(0)] = 2 * global_comparatorI[get_local_id(0) ] - (global_comparatorI[get_local_id(0) ] & (stride - 1));
