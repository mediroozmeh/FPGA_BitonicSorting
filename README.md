...
This sorting network consists of <img align="right"src="https://github.com/mediroozmeh/Bitonic-Sorting/blob/master/Figures/latex_df563c4ffd98b71415248b56a1fff45e.png" width="100" height="25"> comparators,in the following bitonic sorting algorithm is described in more detail.

# Performance and Power consumption Comparison between FPGA and GPU Devices: 
