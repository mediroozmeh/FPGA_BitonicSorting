...
Three different implementation of Bitonic-Sorting algorithm are generated by SDAccel which in the last one performance result is the best.

Bitonic sorting algorithm is synthesized and verified by SDAccel with different optimization techniques which in last performance is the best.

Different version of RTL is generaed by SDACcel which in each Soultion different techniqus are used:
